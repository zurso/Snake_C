...
#define SELF 2
#define WALL 3
//random numbers for direction and trophies
#define ZERO 0
#define ONE 1
#define TWO 2
#define THREE 3
...
//moves the snake
void snakeMove(void);
//this function draws area, snake, and TROPHY
void snakeDraw(void);
//frees taken snake mem allocated
void releaseSnake(void);
//randomly places TROPHY within the games board
...
void snakeDraw(void){
	...
	//foods
	// this will change when we create the random TROPHY creator
	spawnTrophy();
}
